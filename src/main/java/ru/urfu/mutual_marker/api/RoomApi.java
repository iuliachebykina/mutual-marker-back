...
public class RoomApi {
    ...
    public ResponseEntity<Object> selfAddTeacher(@PathVariable Long teacherId, @PathVariable String roomCode){
        try{
    ...
    public ResponseEntity<Object> selfAddStudent(@PathVariable Long studentId, @PathVariable String roomCode){
        try{
